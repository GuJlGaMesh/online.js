(function () {
  ...
  function component(object) {
    ...
    this.initialize = function () {
      ...
      this.externalids().then(function () {
        ...
        var balansers = ['eneyida', 'seasonvar', 'lostfilmhd', 'kinotochka', 'kinopub', 'kinoprofi', 'kinokrad', 'kinobase', 'filmix', 'redheadsound', 'animevost', 'animego', 'animedia', 'animebesst', 'anilibria', 'rezka'];
        if (!balansers.find(function (b) {
  ...
  function startPlugin() {
    ...
    window.lampac_localhost = 'http://abu.land/';
    var manifst = {
      type: 'video',
      version: '1.1.2',
      name: '4K',
